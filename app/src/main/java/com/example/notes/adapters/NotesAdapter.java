...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteViewHolder>{
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder{
        ...
        void setNote(Note note){
            ...
            if (note.getImagePath() != null){
                ...
                imageNote.setVisibility(itemView.VISIBLE);
            }else{
    ...
    public void searchNote(final String keySearch){
        timer = new Timer();
                ...
                if (keySearch.trim().isEmpty()){
                    ...
                    for (Note note : notesSource){
                        if (note.getTitle().toLowerCase().contains(keySearch.toLowerCase()) ||
                            note.getSubtitle().toLowerCase().contains(keySearch.toLowerCase())||
                            note.getNoteText().toLowerCase().contains(keySearch.toLowerCase())){
                            temp.add(note);
                        }
                    }
                    notes = temp;
